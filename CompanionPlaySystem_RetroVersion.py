...
class AntiCloseApp:
    def __init__(self, root):
        ...
        # 协议框架
        self.agreement_frame = tk.Frame(root, bg=BG_COLOR)
        ...
        # 添加复古边框装饰
        self.decoration_frame = tk.Frame(root, bg=BG_COLOR, relief="groove", bd=4)
        self.decoration_frame.pack(side=tk.BOTTOM, fill=tk.X, pady=10)
        tk.Label(
    ...
    def on_checkbox_click(self):
        ...
        if self.agreement_var.get(): 
            self.play_button.config(state=tk.NORMAL, bg=BUTTON_COLOR)
        else:
            self.play_button.config(state=tk.DISABLED, bg="#a0a0a0")
    ...
    def show_change_password_window(self):
        ...
        pwd_window.configure(bg=BG_COLOR)  # 复古背景色

        tk.Label(pwd_window, text="请输入新密码:", bg=BG_COLOR, fg=TEXT_COLOR, font=("MS Sans Serif", 10)).pack(pady=10)
        pwd_entry = tk.Entry(pwd_window, show="*", font=("MS Sans Serif", 10), relief=BORDER_STYLE)
        ...
        button_frame = tk.Frame(pwd_window, bg=BG_COLOR)
    ...
    def show_agreement_window(self):
        ...
        agreement_window.configure(bg=BG_COLOR)  # 复古背景色
...
按下"立即陪玩"必须遵守用户协议。""" 
    ...
    def show_play_window(self):
        ...
        play_window.configure(bg=BG_COLOR)  # 复古背景色
    ...
    def show_unlock_choice(self):
        ...
        choice_window.configure(bg=BG_COLOR)  # 复古背景色
        ...
        # 按钮框架
        button_frame = tk.Frame(choice_window, bg=BG_COLOR)
        button_frame.pack(pady=10)
    ...
    def cardkey_unlock(self, choice_window):
        ...
        cardkey_window.configure(bg=BG_COLOR)  # 复古背景色
    ...
    def get_password(self):
        ...
        password_dialog.configure(bg=BG_COLOR)  # 复古背景色
